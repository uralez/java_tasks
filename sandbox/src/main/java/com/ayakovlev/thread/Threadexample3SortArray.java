 ...
 */
public class Threadexample3SortArray {
    ...
    private static void merge(int[] array, int left, int mid, int right) {
        ...
        int i = left;//index in the left part of array
        int j = mid + 1;//index in the right part of array
        int k = 0;//index of temporal array
    ...
    /*
    Generate random array with values between 0(incl) and 400 (excl)
     */
